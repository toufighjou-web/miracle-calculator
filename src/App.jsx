        ...
        <div style={{ maxWidth: 1000, margin: "0 auto", padding: "0 16px", display: "flex", alignItems: "center", justifyContent: "space-between", height: 62 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <a href="https://miraclefinancial.ca" style={{ display: "flex", alignItems: "center", textDecoration: "none" }}>
              <img src={LOGO_B64} alt="Miracle Financial" style={{ height: 46, width: "auto", display: "block" }}/>
            </a>
          </div>
          ...
          <div style={{ padding: "24px 24px 20px", display: "flex", flexWrap: "wrap", gap: 20, alignItems: "center", justifyContent: "space-between" }}>
            <div>
              <div style={{ marginBottom: 12 }}>
                <img src={LOGO_B64} alt="Miracle Financial" style={{ height: 52, width: "auto", display: "block" }}/>
              </div>
